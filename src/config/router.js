            ...
            children: [
                {
                    ...
                    name: '操作员和权限',
                    children: [
                        { path: '/operator', component: require('../pages/systemManager/operatorManager/operator.vue'), name: '操作员管理', show:true},
                        { path: '/role', component: require('../pages/systemManager/operatorManager/role.vue'), name: '角色管理', show:true},
                        { path: '/assets', component: require('../pages/systemManager/operatorManager/assets.vue'), name: '权限菜单管理', show:true}
                    ],
                    button:[]
                },
                {
                    ...
                    name: '系统数据',
                    children: [
                        { path: '/dictionary', component: require('../pages/systemManager/systemData/dictionary.vue'), name: '数据字典', show:true},
                        { path: '/settings', component: require('../pages/systemManager/systemData/settings.vue'), name: '系统设置', show:true}
                    ],
                    button:[]
                }
            ...
            children: [
                {
                    ...
                    name: '数据分析',
                    children: [
                        { path: '/customerList', component: require('../pages/dataReports/customerList.vue'), name: '客户分析报告', show:true},
                        { path: '/simulate', component: require('../pages/dataReports/simulate.vue'), name: '模拟风控报告', show:true},
                        { path: '/customerList/csReport', component: require('../pages/dataReports/reportView.vue'), name: '查看报告', show:false}
                    ],
                    button:[]
                }
            ...
            children: [
                {
                    ...
                    name: '数据报表',
                    children: [
                        { path: '/riskSummary', component: require('../pages/riskReports/riskSummary.vue'), name: '风险汇总表', show:true},
                        { path: '/productAnalysis', component: require('../pages/riskReports/productAnalysis.vue'), name: '产品分析表', show:true},
                        { path: '/ruleAnalysis', component: require('../pages/riskReports/ruleAnalysis.vue'), name: '规则分析表', show:true},
                        { path: '/ruleAnalysis/demo', component: require('../pages/riskReports/ruleAnalysis.echarts.vue'), name: '规则分析表', show:true},
                        { path: '/exceptionRule', component: require('../pages/riskReports/exceptionRule.vue'), name: '异常规则命中表', show:true},
                        { path: '/scoreDistribution', component: require('../pages/riskReports/scoreDistribution.vue'), name: '评分分布表', show:true},
                        { path: '/interfaceQuery', component: require('../pages/riskReports/interfaceQuery.vue'), name: '接口查询表', show:true}
                    ],
                    button:[]
                }
